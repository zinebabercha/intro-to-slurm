...
2. Get your copie of the project.
...
4. clone the repo:
go to your repositories and open the repo, click on the code button (in green color), copie the link, and open your terminal, then 
...
```bash
git clone git@github.com:<username>/intro-to-slurm.git
```
